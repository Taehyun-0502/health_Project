...
public class SettleService {
    ...
    public PagedResponse<PayDTO> payList(Long username, Pager pager) throws Exception {
        pager.makeOffset();
        List<PayDTO> items = settleMapper.payList(username, pager);
    ...
    public PagedResponse<CommissionDTO> commissionList(Pager pager) throws Exception {
        pager.makeOffset();
        List<CommissionDTO> items = settleMapper.commissionList(pager);
    ...
    public PagedResponse<ExpenseDTO> expenseList(Long username, Pager pager) throws Exception {
        pager.makeOffset();
        List<ExpenseDTO> items = settleMapper.expenseList(username, pager);
