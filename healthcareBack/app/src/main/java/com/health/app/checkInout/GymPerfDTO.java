...
// 총괄 관리자(admin)용 매장별 비교 지표 DTO (트레이너 수 / 이번 달 수업·미수행 / 재등록·만료 임박 / 제휴 계약 기간)
@Getter
@Setter
@ToString
public class GymPerfDTO {
    ...
    // 매장과의 최신 제휴 계약(contract=1) 정보 - 만료 관리용
    private java.time.LocalDate contractStartDate; // 제휴 계약 시작일
    private java.time.LocalDate contractEndDate; // 제휴 계약 종료일
    private String contractStatus; // 제휴 계약 상태 (SIGNED/EXPIRED 등, 없으면 null)
